...
public class HorrorGameJME extends SimpleApplication {
    ...
    private PostProcessingManager postProcessingManager; // ADDED: Horror post-processing effects
    ...
    public void simpleInitApp() {// Initialize physics (without debug for cleaner view)
        ...
        // ADDED: Initialize post-processing effects
    ...
    private void setupProperLighting() {// Clear existing lights
        ...
        ambient.setColor(ColorRGBA.White.mult(0.2f)); // Dimmer for horror atmosphere
        rootNode.addLight(ambient);

        // Main directional light
        DirectionalLight sun = new DirectionalLight();
        sun.setDirection(new Vector3f(-0.5f, -0.5f, -0.5f).normalizeLocal());
        sun.setColor(ColorRGBA.White.mult(0.05f)); // Dimmer for atmosphere
    ...
    private void setupPlayerSystems() {// Create regular player for torch and other features
        ...
        Vector3f weaponScreenPos = new Vector3f(
                settings.getWidth() / 2f - 600f,
                settings.getHeight() - 800f,
                0
        );
    ...
    private void cleanupGame() {if (playerControl != null) {
        ...
        // ADDED: Cleanup post-processing effects
    ...
    public void simpleUpdate(float tpf) {
        ...
        if (gameStateManager.getCurrentState() == GameStateManager.GameState.PLAYING) {
            ...
            // ADDED: Update post-processing effects
            if (postProcessingManager != null) {
                postProcessingManager.update(tpf, player);
            }
        }
    }
